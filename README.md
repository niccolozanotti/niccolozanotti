...
- [`Cambridge-ICCS/FTorch`](https://github.com/Cambridge-ICCS/FTorch/): A library for directly calling PyTorch ML models from Fortran

My work is usually signed with this [Public GPG key](https://meta.sr.ht/~niccolozanotti.pgp).

I've been [reviewing](https://joss.theoj.org/papers/reviewed_by/@niccolozanotti) for the awesome [Journal of Open Source Software](https://joss.theoj.org/).
